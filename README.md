...
- Lệch lỗi github:
    S E:\mediasoft-1\master-api> git pull error: Your local changes to the following files would be overwritten by merge: font-end-master/src/router/index.js loi github < git reset --hard >
    git push origin master -f : dùng khi lỗi ( error: failed to push some refs to 'https://github.com/dangkhoi1998/master-api.git' )